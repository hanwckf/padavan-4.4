...
static inline void print_event(struct pd_port_t *pd_port, struct pd_event_t *pd_event)
{
#if PE_EVENT_DBG_ENABLE
...
bool pd_make_pe_state_transit(struct pd_port_t *pd_port,
	uint8_t curr_state, const struct pe_state_reaction_t *state_reaction)
{
	int i;
...
bool pd_make_pe_state_transit_virt(struct pd_port_t *pd_port,
	uint8_t curr_state, const struct pe_state_reaction_t *state_reaction)
{
