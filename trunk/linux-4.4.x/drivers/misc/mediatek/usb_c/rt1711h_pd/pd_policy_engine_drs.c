...
void pe_drs_dfp_ufp_send_dr_swap_entry(struct pd_port_t *pd_port, struct pd_event_t *pd_event)
{
...
void pe_drs_ufp_dfp_send_dr_swap_entry(struct pd_port_t *pd_port, struct pd_event_t *pd_event)
{
	pd_send_ctrl_msg(pd_port, TCPC_TX_SOP, PD_CTRL_DR_SWAP);
}
