...
void pe_snk_startup_entry(struct pd_port_t *pd_port, struct pd_event_t *pd_event);
void pe_snk_discovery_entry(struct pd_port_t *pd_port, struct pd_event_t *pd_event);
void pe_snk_wait_for_capabilities_entry(
			struct pd_port_t *pd_port, struct pd_event_t *pd_event);
void pe_snk_evaluate_capability_entry(struct pd_port_t *pd_port, struct pd_event_t *pd_event);
void pe_snk_select_capability_entry(struct pd_port_t *pd_port, struct pd_event_t *pd_event);
void pe_snk_transition_sink_entry(struct pd_port_t *pd_port, struct pd_event_t *pd_event);
void pe_snk_ready_entry(struct pd_port_t *pd_port, struct pd_event_t *pd_event);
void pe_snk_hard_reset_entry(struct pd_port_t *pd_port, struct pd_event_t *pd_event);
void pe_snk_transition_to_default_entry(
				struct pd_port_t *pd_port, struct pd_event_t *pd_event);
void pe_snk_give_sink_cap_entry(struct pd_port_t *pd_port, struct pd_event_t *pd_event);
void pe_snk_get_source_cap_entry(struct pd_port_t *pd_port, struct pd_event_t *pd_event);
void pe_snk_send_soft_reset_entry(struct pd_port_t *pd_port, struct pd_event_t *pd_event);
void pe_snk_soft_reset_entry(struct pd_port_t *pd_port, struct pd_event_t *pd_event);

void pe_snk_wait_for_capabilities_exit(
			struct pd_port_t *pd_port, struct pd_event_t *pd_event);
void pe_snk_select_capability_exit(struct pd_port_t *pd_port, struct pd_event_t *pd_event);
void pe_snk_transition_sink_exit(struct pd_port_t *pd_port, struct pd_event_t *pd_event);
...
extern void pe_src_startup_entry(struct pd_port_t *pd_port, struct pd_event_t *pd_event);
void pe_src_discovery_entry(struct pd_port_t *pd_port, struct pd_event_t *pd_event);
void pe_src_send_capabilities_entry(struct pd_port_t *pd_port, struct pd_event_t *pd_event);
void pe_src_negotiate_capabilities_entry(
				struct pd_port_t *pd_port, struct pd_event_t *pd_event);
void pe_src_transition_supply_entry(struct pd_port_t *pd_port, struct pd_event_t *pd_event);
void pe_src_transition_supply2_entry(struct pd_port_t *pd_port, struct pd_event_t *pd_event);
void pe_src_ready_entry(struct pd_port_t *pd_port, struct pd_event_t *pd_event);
void pe_src_disabled_entry(struct pd_port_t *pd_port, struct pd_event_t *pd_event);
void pe_src_capability_response_entry(struct pd_port_t *pd_port, struct pd_event_t *pd_event);
void pe_src_hard_reset_entry(struct pd_port_t *pd_port, struct pd_event_t *pd_event);
void pe_src_hard_reset_received_entry(struct pd_port_t *pd_port, struct pd_event_t *pd_event);
void pe_src_transition_to_default_entry(
			struct pd_port_t *pd_port, struct pd_event_t *pd_event);
void pe_src_give_source_cap_entry(struct pd_port_t *pd_port, struct pd_event_t *pd_event);
void pe_src_get_sink_cap_entry(struct pd_port_t *pd_port, struct pd_event_t *pd_event);
void pe_src_wait_new_capabilities_entry(
				struct pd_port_t *pd_port, struct pd_event_t *pd_event);
void pe_src_send_soft_reset_entry(struct pd_port_t *pd_port, struct pd_event_t *pd_event);
void pe_src_soft_reset_entry(struct pd_port_t *pd_port, struct pd_event_t *pd_event);
void pe_src_ping_entry(struct pd_port_t *pd_port, struct pd_event_t *pd_event);

#ifdef CONFIG_USB_PD_SRC_STARTUP_DISCOVER_ID
void pe_src_vdm_identity_request_entry(
			struct pd_port_t *pd_port, struct pd_event_t *pd_event);
void pe_src_vdm_identity_acked_entry(struct pd_port_t *pd_port, struct pd_event_t *pd_event);
void pe_src_vdm_identity_naked_entry(struct pd_port_t *pd_port, struct pd_event_t *pd_event);
#endif

void pe_src_send_capabilities_exit(struct pd_port_t *pd_port, struct pd_event_t *pd_event);
void pe_src_transition_supply_exit(struct pd_port_t *pd_port, struct pd_event_t *pd_event);
void pe_src_transition_to_default_exit(
				struct pd_port_t *pd_port, struct pd_event_t *pd_event);
void pe_src_get_sink_cap_exit(struct pd_port_t *pd_port, struct pd_event_t *pd_event);
...
void pe_prs_src_snk_transition_to_off_entry(
				struct pd_port_t *pd_port, struct pd_event_t *pd_event);
void pe_prs_src_snk_assert_rd_entry(struct pd_port_t *pd_port, struct pd_event_t *pd_event);
void pe_prs_src_snk_wait_source_on_entry(
				struct pd_port_t *pd_port, struct pd_event_t *pd_event);
void pe_prs_src_snk_send_swap_entry(struct pd_port_t *pd_port, struct pd_event_t *pd_event);
...
void pe_prs_snk_src_transition_to_off_entry(
				struct pd_port_t *pd_port, struct pd_event_t *pd_event);
void pe_prs_snk_src_assert_rp_entry(struct pd_port_t *pd_port, struct pd_event_t *pd_event);
void pe_prs_snk_src_source_on_entry(struct pd_port_t *pd_port, struct pd_event_t *pd_event);
void pe_prs_snk_src_send_swap_entry(struct pd_port_t *pd_port, struct pd_event_t *pd_event);
void pe_prs_snk_src_reject_swap_entry(struct pd_port_t *pd_port, struct pd_event_t *pd_event);

void pe_prs_src_snk_wait_source_on_exit(
				struct pd_port_t *pd_port, struct pd_event_t *pd_event);
void pe_prs_snk_src_transition_to_off_exit(
				struct pd_port_t *pd_port, struct pd_event_t *pd_event);
void pe_prs_snk_src_source_on_exit(struct pd_port_t *pd_port, struct pd_event_t *pd_event);

/* ---- Policy Engine (DR) ---- */

void pe_dr_src_get_source_cap_entry(struct pd_port_t *pd_port, struct pd_event_t *pd_event);
void pe_dr_src_give_sink_cap_entry(struct pd_port_t *pd_port, struct pd_event_t *pd_event);
void pe_dr_snk_get_sink_cap_entry(struct pd_port_t *pd_port, struct pd_event_t *pd_event);
void pe_dr_snk_give_source_cap_entry(struct pd_port_t *pd_port, struct pd_event_t *pd_event);

void pe_dr_src_get_source_cap_exit(struct pd_port_t *pd_port, struct pd_event_t *pd_event);
void pe_dr_snk_get_sink_cap_exit(struct pd_port_t *pd_port, struct pd_event_t *pd_event);
...
void pe_ufp_vdm_get_identity_entry(struct pd_port_t *pd_port, struct pd_event_t *pd_event);
void pe_ufp_vdm_send_identity_entry(struct pd_port_t *pd_port, struct pd_event_t *pd_event);
void pe_ufp_vdm_get_identity_nak_entry(
				struct pd_port_t *pd_port, struct pd_event_t *pd_event);

void pe_ufp_vdm_get_svids_entry(struct pd_port_t *pd_port, struct pd_event_t *pd_event);
void pe_ufp_vdm_send_svids_entry(struct pd_port_t *pd_port, struct pd_event_t *pd_event);
void pe_ufp_vdm_get_svids_nak_entry(struct pd_port_t *pd_port, struct pd_event_t *pd_event);

void pe_ufp_vdm_get_modes_entry(struct pd_port_t *pd_port, struct pd_event_t *pd_event);
void pe_ufp_vdm_send_modes_entry(struct pd_port_t *pd_port, struct pd_event_t *pd_event);
void pe_ufp_vdm_get_modes_nak_entry(struct pd_port_t *pd_port, struct pd_event_t *pd_event);

void pe_ufp_vdm_evaluate_mode_entry_entry(
				struct pd_port_t *pd_port, struct pd_event_t *pd_event);
void pe_ufp_vdm_mode_entry_ack_entry(struct pd_port_t *pd_port, struct pd_event_t *pd_event);
void pe_ufp_vdm_mode_entry_nak_entry(struct pd_port_t *pd_port, struct pd_event_t *pd_event);

void pe_ufp_vdm_mode_exit_entry(struct pd_port_t *pd_port, struct pd_event_t *pd_event);
void pe_ufp_vdm_mode_exit_ack_entry(struct pd_port_t *pd_port, struct pd_event_t *pd_event);
void pe_ufp_vdm_mode_exit_nak_entry(struct pd_port_t *pd_port, struct pd_event_t *pd_event);
...
void pe_ufp_vdm_dp_status_update_entry(
				struct pd_port_t *pd_port, struct pd_event_t *pd_event);
void pe_ufp_vdm_dp_configure_entry(struct pd_port_t *pd_port, struct pd_event_t *pd_event);
#endif	/* CONFIG_USB_PD_ALT_MODE */

#ifdef CONFIG_USB_PD_UVDM
void pe_ufp_uvdm_recv_entry(struct pd_port_t *pd_port, struct pd_event_t *pd_event);
#endif	/* CONFIG_USB_PD_UVDM */
...
void pe_dfp_vdm_mode_exit_request_entry(
				struct pd_port_t *pd_port, struct pd_event_t *pd_event);
void pe_dfp_vdm_mode_exit_acked_entry(struct pd_port_t *pd_port, struct pd_event_t *pd_event);
