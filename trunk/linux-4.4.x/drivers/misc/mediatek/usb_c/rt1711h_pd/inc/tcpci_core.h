...
struct tcpc_device {
	...
	struct pd_msg_t pd_last_vdm_msg;
	struct pd_event_t pd_vdm_event;

	struct pd_msg_t pd_msg_buffer[PD_MSG_BUF_SIZE];
	struct pd_event_t pd_event_ring_buffer[PD_EVENT_BUF_SIZE];
