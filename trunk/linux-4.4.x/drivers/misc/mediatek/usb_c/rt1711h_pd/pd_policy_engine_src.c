...
void pe_src_startup_entry(struct pd_port_t *pd_port, struct pd_event_t *pd_event)
{
...
void pe_src_transition_to_default_exit(struct pd_port_t *pd_port, struct pd_event_t *pd_event)
{
...
void pe_src_vdm_identity_request_entry(struct pd_port_t *pd_port, struct pd_event_t *pd_event)
{
